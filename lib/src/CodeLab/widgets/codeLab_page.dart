            ...
            children: <Widget>[
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: Row(
                    children: const [Icon(Icons.stream), Text(' Stream')],
                  ),
                ),
              ),
              const Divider(),
              OutlinedButton(
                ...
                child: Row(children: const [Icon(Icons.note), Text(' Note')]),
              ),
              OutlinedButton(
                onPressed: () {
                  Navigator.push(
                ...
                child: Row(children: const [Icon(Icons.speed), Text(' SPEED')]),
              ),
              OutlinedButton(
                onPressed: () {
                  Navigator.push(
                ...
                child: Row(
                  children: const [Icon(Icons.smart_button), Text(' Qubit')],
                ),
              ),
            ],
          ),
